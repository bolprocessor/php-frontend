...
$objects_file = $grammar_file = $csound_file = $tuning_file = $alphabet_file = $settings_file = $orchestra_file = $interaction_file = $midisetup_file = $timebase_file = $keyboard_file = $glossary_file = '';
...
echo "<font color=\"red\">➡</font> Changes in prototypes are <font color=\"red\">autosaved</font> every 30 seconds if changes occurred. Keep this page open as long as you are editing sound-object prototypes!</p>";
